...
public sealed partial class MainForm : Form
{
    ...
    readonly Label _lastError = new() { AutoSize = false, Dock = DockStyle.Fill, ForeColor = Color.Firebrick, Text = "Lỗi: không có", TextAlign = ContentAlignment.MiddleLeft, Visible = false };
    ...
    static readonly Color ActiveTabColor = UiTheme.Primary;
    static readonly Color ActiveTabUnderlineColor = Color.FromArgb(165, 180, 252);
    static readonly Color InactiveTabColor = Color.FromArgb(248, 250, 252);
    static readonly Color HoveredTabColor = UiTheme.PrimarySoft;
    static readonly Color TabBorderColor = UiTheme.Border;
    static readonly Color InactiveTabTextColor = UiTheme.TextSecondary;
    ...
    public MainForm(StartupOptions startupOptions)
    {
        ...
        Text = _managedMode
            ? $"TikTok Automation Worker {AppVersionInfo.Display} — {_startupOptions.ProfileName}"
            : $"TikTok Automation Console {AppVersionInfo.Display}";
    ...
    void BuildUi()
    {
        var tabs = new TabControl
        {
            ...
            ItemSize = new Size(136, 38),
            SizeMode = TabSizeMode.Normal
        };
        ConfigureTabAppearance(tabs);
        var operations = BuildGeneralTab();
        operations.Text = "Vận hành";
        var viewer = BuildViewerTab();
        viewer.Text = "Người xem";
        var diagnostics = new TabPage("Chẩn đoán") { BackColor = UiTheme.Canvas, Padding = new Padding(8) };
        var diagnosticTabs = new TabControl { Dock = DockStyle.Fill, Padding = new Point(12, 5) };
        var inputGuard = BuildInputGuardTab(); inputGuard.Text = "Bảo vệ nhập liệu";
        var vmOptimization = BuildVmOptimizationTab(); vmOptimization.Text = "Tối ưu hệ thống";
        var oldLive = BuildOldLiveTab(); oldLive.Text = "LIVE đã xem";
        var errors = BuildDiagnosticsTab(); errors.Text = "Sự cố";
        var log = BuildLogTab(); log.Text = "Nhật ký";
        diagnosticTabs.TabPages.AddRange([inputGuard, vmOptimization, oldLive, errors, log]);
        diagnostics.Controls.Add(diagnosticTabs);
        tabs.TabPages.AddRange([operations, viewer, diagnostics]);
        Controls.Add(tabs);
        ...
        Panel StatusCard(Control content, Color tint)
        {
            var card = new Panel { Dock = DockStyle.Fill, Margin = new Padding(4), Padding = new Padding(10, 2, 8, 2), BackColor = tint };
            card.Controls.Add(content);
            UiTheme.ApplyRoundedCorners(card, 8);
            return card;
        }
        status.Controls.Add(StatusCard(_runState, Color.FromArgb(236, 253, 245)), 0, 0);
        status.Controls.Add(StatusCard(_roundState, Color.FromArgb(245, 247, 255)), 1, 0);
        status.Controls.Add(StatusCard(_sessionRuntimeState, Color.FromArgb(239, 246, 255)), 0, 1);
        status.Controls.Add(StatusCard(_todayRuntimeState, Color.FromArgb(240, 253, 250)), 1, 1);
        status.Controls.Add(_totalRuntimeState, 0, 2);
        status.Controls.Add(_periodicState, 1, 2);
        status.Controls.Add(_runDetail, 0, 3);
        status.Controls.Add(_lastError, 1, 3);
    ...
    void DrawTab(TabControl tabs, DrawItemEventArgs e)
    {
        ...
        using Font? activeFont = active ? new Font("Segoe UI Semibold", 9F, FontStyle.Bold) : null;
    ...
    {
        _runState.Font = new Font("Segoe UI Semibold", 9.5F, FontStyle.Bold);
        _runState.ForeColor = UiTheme.Success;
        _runDetail.ForeColor = UiTheme.Primary;
        _roundState.ForeColor = UiTheme.TextSecondary;
        _sessionRuntimeState.ForeColor = Color.FromArgb(2, 132, 199);
        _todayRuntimeState.ForeColor = UiTheme.Success;
        _totalRuntimeState.ForeColor = UiTheme.TextSecondary;
        UpdateRunControlButtons();
        _periodicState.ForeColor = UiTheme.Primary;
        _lastError.ForeColor = UiTheme.TextSecondary;
        _chromeState.ForeColor = UiTheme.TextSecondary;
        _chromePageState.ForeColor = UiTheme.TextSecondary;
    ...
    void UpdateRunControlButtons()
    {
        ...
        if (_startStopCommandInFlight)
        {
            ...
            SetRunControlAppearance(_runStopButton, stopping ? "■  Đang dừng hồ sơ..." : "▶  Đang chạy hồ sơ...", Color.FromArgb(138, 145, 153), false);
        ...
        if (!_engine.Running)
        {
            SetRunControlAppearance(_runStopButton, "▶  Chạy hồ sơ", Color.FromArgb(35, 137, 73), true);
            SetRunControlAppearance(_pauseResumeButton, "⏸  Tạm dừng", Color.FromArgb(138, 145, 153), false);
        ...
        {
            SetRunControlAppearance(_runStopButton, "■  Dừng hồ sơ", Color.FromArgb(196, 58, 58), false);
        ...
        if (_engine.Paused)
        {
            SetRunControlAppearance(_runStopButton, "■  Dừng hồ sơ", Color.FromArgb(196, 58, 58), true);
    ...
    {
        var tab = new TabPage("Cấu hình vận hành");
        ...
        contentLayout.RowStyles.Add(new RowStyle(SizeType.AutoSize));
        contentLayout.RowStyles.Add(new RowStyle(SizeType.AutoSize));
        contentLayout.Controls.Add(BuildTimingGroup(), 0, 0);
        ...
        contentLayout.Controls.Add(contentGroup, 0, 1);
        contentLayout.Controls.Add(BuildAdvancedSettingsSection(), 0, 2);
    ...
    Control BuildAdvancedSettingsSection()
    {
        ...
        body.Controls.Add(BuildChromeGroup(), 0, 0);
        body.Controls.Add(BuildXPathGroup(), 0, 1);
        var toggle = Btn("›  Nâng cao — XPath, CDP và hover", (_, _) =>
        {
            body.Visible = !body.Visible;
            ((Button)root.Controls[0]).Text = body.Visible
                ? "⌄  Nâng cao — XPath, CDP và hover"
                : "›  Nâng cao — XPath, CDP và hover";
        });
        toggle.Dock = DockStyle.Top;
        toggle.Height = 42;
        toggle.TextAlign = ContentAlignment.MiddleLeft;
        root.Controls.Add(toggle, 0, 0);
    ...
    Control BuildXPathGroup()
    {
        ...
        t.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 55F));
        t.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
        ...
        t.Controls.Add(downWrap, 0, 0); t.SetColumnSpan(downWrap, 3);
        ...
        t.Controls.Add(hoverFlow, 0, 5); t.SetColumnSpan(hoverFlow, 3);
    ...
    void AddXPathRow(TableLayoutPanel t, int row, string name, TextBox box, Func<Task> pick, Func<Task> test, string testText)
    {
        ...
        t.Controls.Add(Btn("Chỉnh sửa", (_, _) => ShowXPathEditor(name, box, pick, test, testText)), 2, row);
    }

    void ShowXPathEditor(string name, TextBox source, Func<Task>? pick = null, Func<Task>? test = null, string testText = "Thử")
    {
        ...
        var repick = new Button { Text = "Lấy lại XPath", AutoSize = true };
        var tryButton = new Button { Text = testText, AutoSize = true };
        repick.Click += async (_, _) => { if (pick is not null) { await pick(); edit.Text = source.Text; } };
        tryButton.Click += async (_, _) => { if (test is not null) { source.Text = edit.Text.Trim(); await test(); } };
        ModernDialog.StylePrimaryButton(ok);
        ModernDialog.StyleSecondaryButton(cancel);
        ModernDialog.StyleSecondaryButton(repick);
        ModernDialog.StyleSecondaryButton(tryButton);
        bar.Controls.Add(ok); bar.Controls.Add(cancel); bar.Controls.Add(tryButton); bar.Controls.Add(repick); f.Controls.Add(edit); f.Controls.Add(bar); f.AcceptButton = ok; f.CancelButton = cancel;
        if (f.ShowDialog(this) == DialogResult.OK) source.Text = edit.Text.Trim();
    }

    Control BuildTimingGroup()
    {
        var g = new GroupBox { Text = "Thời gian vận hành", Dock = DockStyle.Top, AutoSize = true, AutoSizeMode = AutoSizeMode.GrowAndShrink, Padding = new Padding(12, 10, 12, 12), Margin = new Padding(0, 0, 0, 8) };
        var timingTable = new TableLayoutPanel { Dock = DockStyle.Top, AutoSize = true, ColumnCount = 6, RowCount = 3, Margin = Padding.Empty };
        timingTable.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 210));
        timingTable.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 100));
        timingTable.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 38));
        timingTable.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 38));
        timingTable.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 100));
        timingTable.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100));

        var lblDelay = new Label { Text = "Độ trễ giữa thao tác", AutoSize = true, Anchor = AnchorStyles.Left, Margin = new Padding(0, 8, 10, 8) };
        var lblLoop = new Label { Text = "Nghỉ sau mỗi vòng", AutoSize = true, Anchor = AnchorStyles.Left, Margin = new Padding(0, 8, 10, 8) };
        void AddRangeRow(int row, Label title, NumericUpDown from, NumericUpDown to)
        {
            from.Margin = new Padding(0, 4, 4, 4); to.Margin = new Padding(0, 4, 4, 4);
            timingTable.Controls.Add(title, 0, row);
            timingTable.Controls.Add(from, 1, row);
            timingTable.Controls.Add(new Label { Text = "ms", AutoSize = true, Anchor = AnchorStyles.Left }, 2, row);
            timingTable.Controls.Add(new Label { Text = "→", AutoSize = true, Anchor = AnchorStyles.Left, ForeColor = UiTheme.TextSecondary }, 3, row);
            timingTable.Controls.Add(to, 4, row);
            timingTable.Controls.Add(new Label { Text = "ms", AutoSize = true, Anchor = AnchorStyles.Left }, 5, row);
        }
        AddRangeRow(0, lblDelay, _delayMin, _delayMax);
        AddRangeRow(1, lblLoop, _loopMin, _loopMax);

        var options = new FlowLayoutPanel { Dock = DockStyle.Fill, AutoSize = true, WrapContents = true, Margin = new Padding(0, 6, 0, 0) };
        AddLabeled(options, "F5 định kỳ (phút)", _periodicMin);
        AddLabeled(options, "Hẹn dừng (phút, 0 = không)", _timerStop);
        timingTable.Controls.Add(options, 0, 2); timingTable.SetColumnSpan(options, 6);
        ...
        foreach (var control in new Control[] { lblDelay, _delayMin, _delayMax })
            _toolTip.SetToolTip(control, delayTip);
        foreach (var control in new Control[] { lblLoop, _loopMin, _loopMax })
            _toolTip.SetToolTip(control, loopTip);
        g.Controls.Add(timingTable);
        return g;
    }
    ...
    {
        var t = new TabPage("Kiểm tra và lỗi");
