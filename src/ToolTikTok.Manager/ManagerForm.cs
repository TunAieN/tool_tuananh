...
public sealed partial class ManagerForm : Form
{
    sealed class ProfileContext
    {
        ...
        public SemaphoreSlim WorkerStartupGate { get; } = new(1, 1);
        public DateTime WorkerStartedUtc { get; set; } = DateTime.MinValue;
        public bool WorkerExpectedStop { get; set; }
        public string WorkerStopReason { get; set; } = "";
    }
    ...
    readonly ToolTip _managerToolTip = new() { AutoPopDelay = 10000, InitialDelay = 350, ReshowDelay = 150, ShowAlways = true };
    ...
    public ManagerForm()
    {
        ...
        Text = $"TikTok Operations Center {AppVersionInfo.Display}";
        ...
        {
            await RefreshOpenProfilesAsync();
    ...
    void BuildLayout()
    {
        ...
        var brand = new Panel { Dock = DockStyle.Top, Height = 108, BackColor = UiTheme.Sidebar };
        ...
        UiTheme.ApplyRoundedCorners(brandIcon, 12);
        brand.Controls.Add(brandIcon);
        brand.Controls.Add(new Label
        {
            Text = "TikTok Operations",
            AutoSize = true,
        ...
        UiTheme.ApplyRoundedCorners(versionBadge, 11);
        brand.Controls.Add(versionBadge);
        ...
        var sidebarFooter = new TableLayoutPanel
        {
        ...
        sidebarFooter.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
        sidebarFooter.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
        sidebarFooter.RowStyles.Add(new RowStyle(SizeType.Absolute, 52F));
        sidebarFooter.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
        var startAll = Button("▶  Chạy tất cả", async (_, _) => await StartAllAsync(), UiButtonKind.Primary);
        var stopAll = Button("■  Dừng tất cả", async (_, _) => await StopAllAsync(), UiButtonKind.Danger);
        startAll.Dock = DockStyle.Fill;
        stopAll.Dock = DockStyle.Fill;
        startAll.Margin = new Padding(0, 2, 4, 0);
        stopAll.Margin = new Padding(4, 2, 0, 0);
        startAll.Padding = Padding.Empty;
        stopAll.Padding = Padding.Empty;
        startAll.Font = new Font("Segoe UI Semibold", 7.75F, FontStyle.Bold);
        stopAll.Font = new Font("Segoe UI Semibold", 7.75F, FontStyle.Bold);
        startAll.BackColor = Color.FromArgb(30, 41, 59);
        startAll.ForeColor = Color.FromArgb(134, 239, 172);
        startAll.FlatAppearance.BorderColor = Color.FromArgb(51, 65, 85);
        stopAll.BackColor = Color.FromArgb(30, 41, 59);
        stopAll.ForeColor = Color.FromArgb(252, 165, 165);
        stopAll.FlatAppearance.BorderColor = Color.FromArgb(51, 65, 85);
        _availability.Dock = DockStyle.Fill;
        _availability.AutoSize = false;
        _availability.TextAlign = ContentAlignment.MiddleLeft;
        _availability.Padding = new Padding(8, 0, 0, 0);
        _availability.Margin = new Padding(0, 0, 0, 8);
        _availability.BackColor = Color.FromArgb(30, 41, 59);
        _availability.ForeColor = Color.FromArgb(148, 163, 184);
        _availability.Font = new Font("Segoe UI", 8.5F);
        UiTheme.ApplyRoundedCorners(_availability, 11);
        sidebarFooter.Controls.Add(_availability, 0, 0);
        sidebarFooter.SetColumnSpan(_availability, 2);
        sidebarFooter.Controls.Add(startAll, 0, 1);
        sidebarFooter.Controls.Add(stopAll, 1, 1);

        sidebar.Controls.Add(nav);
        sidebar.Controls.Add(sidebarFooter);
        sidebar.Controls.Add(brand);

        var workspace = new ModernGradientPanel
        {
            Dock = DockStyle.Fill,
        ...
        workspaceHeader.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 55F));
        workspaceHeader.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 45F));
        workspaceHeader.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
        var welcome = new Panel { Dock = DockStyle.Fill, BackColor = Color.FromArgb(248, 250, 252) };
        ...
        UiTheme.ApplyRoundedCorners(welcomeIcon, 21);
        welcome.Controls.Add(welcomeIcon);
        ...
        welcome.Controls.Add(_workspaceTitle);
        _workspaceSubtitle = new Label
        {
            Text = "Quản lý và vận hành hồ sơ tập trung.",
            AutoSize = true,
            Location = new Point(51, 35),
            ForeColor = UiTheme.TextSecondary,
            Font = new Font("Segoe UI", 9.5F)
        };
        welcome.Controls.Add(_workspaceSubtitle);
        _workspaceIcon = welcomeIcon;
        ...
        UiTheme.ApplyRoundedCorners(health, 10);
        var settings = new Button
        {
            Text = "⚙",
            Dock = DockStyle.Fill,
            Margin = new Padding(0, 4, 8, 4),
            AccessibleName = "Thiết lập"
        };
        UiTheme.StyleButton(settings, UiButtonKind.Neutral);
        ...
        UiTheme.StyleButton(checkUpdate, UiButtonKind.Primary);
        checkUpdate.Font = new Font("Segoe UI Semibold", 8F, FontStyle.Bold);
        checkUpdate.Padding = Padding.Empty;
        ...
        tabCard.Controls.Add(_tabs);
        workspace.Controls.Add(tabCard);
        workspace.Controls.Add(workspaceHeader);
    ...
    {
        var b = new Button { Text = text, AutoSize = true, Height = 36, Margin = new Padding(4) };
    ...
    void RefreshAvailability()
    {
        ...
        _availability.Text = count == 0 ? "Tất cả hồ sơ đã được mở" : $"Hồ sơ chưa mở: {count}";
    }
    ...
    void UpdateWorkspaceTabBarAppearance()
    {
        if (_tabs.IsDisposed) return;
        var hasWorkspace = _tabs.TabPages.Cast<TabPage>().Any(page => page.Tag is ProfileContext);
        _tabs.ItemSize = hasWorkspace ? new Size(148, 36) : new Size(1, 1);
        _tabs.Padding = hasWorkspace ? new Point(12, 4) : Point.Empty;
        _tabs.Invalidate();
    }
    ...
    void DrawTabs(object? sender, DrawItemEventArgs e)
    {
        ...
        if (e.Bounds.Height < 8 || e.Bounds.Width < 8) return;
        ...
        var foreground = active ? Color.White : UiTheme.TextSecondary;
        var tabBounds = Rectangle.Inflate(e.Bounds, -3, -3);
        using var tabPath = new System.Drawing.Drawing2D.GraphicsPath();
        const int tabRadius = 9;
        var diameter = tabRadius * 2;
        tabPath.AddArc(tabBounds.Left, tabBounds.Top, diameter, diameter, 180, 90);
        tabPath.AddArc(tabBounds.Right - diameter, tabBounds.Top, diameter, diameter, 270, 90);
        tabPath.AddArc(tabBounds.Right - diameter, tabBounds.Bottom - diameter, diameter, diameter, 0, 90);
        tabPath.AddArc(tabBounds.Left, tabBounds.Bottom - diameter, diameter, diameter, 90, 90);
        tabPath.CloseFigure();
        ...
        var textRect = new Rectangle(e.Bounds.X + 12, e.Bounds.Y + 4, e.Bounds.Width - (closeable ? 30 : 18), e.Bounds.Height - 8);
        var profileName = page.Tag is ProfileContext context ? context.Profile.Name : page.Text;
        var text = active ? "● " + profileName : profileName;
        using var tabFont = new Font("Segoe UI Semibold", 9F, active ? FontStyle.Bold : FontStyle.Regular);
    ...
    void EnsureTab(ProfileContext ctx)
    {
        ...
        var page = new TabPage(ctx.Profile.Name) { Tag = ctx, BackColor = UiTheme.Canvas, Padding = new Padding(10) };
        ...
        var viewChrome = Button("Hiện Chrome", async (_, _) => { try { await ViewChromeForProfileAsync(ctx); } catch (Exception ex) { ShowError(ex); } }, UiButtonKind.Neutral);
        ...
        var more = Button("⋯  Thêm", (_, _) => { });
        var moreMenu = new ContextMenuStrip();
        moreMenu.Items.Add("Hiện cửa sổ Chrome", null, async (_, _) => { try { await ViewChromeForProfileAsync(ctx); } catch (Exception ex) { ShowError(ex); } });
        moreMenu.Items.Add("Thiết lập tài khoản", null, (_, _) => ConfigureTikTokAccount(ctx));
        var detachItem = moreMenu.Items.Add("Tách Worker", null, (_, _) => detach.PerformClick());
        moreMenu.Items.Add(new ToolStripSeparator());
        moreMenu.Items.Add("Chi tiết Worker", null, (_, _) => ShowWorkerTechnicalInfo(ctx));
        moreMenu.Items.Add("Thông tin CDP", null, (_, _) => ShowCdpTechnicalInfo(ctx));
        moreMenu.Opening += (_, _) => detachItem.Text = ctx.Detached ? "Gắn Worker vào cửa sổ" : "Tách Worker";
        more.Click += (_, _) => moreMenu.Show(more, new Point(0, more.Height));
        _managerToolTip.SetToolTip(openChrome, "Khởi chạy Chrome bằng profile đang chọn.");
        _managerToolTip.SetToolTip(viewChrome, "Đưa cửa sổ Chrome của profile ra phía trước.");
        _managerToolTip.SetToolTip(detach, "Mở Worker thành một cửa sổ riêng biệt.");
        top.Controls.Add(profileHeader, 0, 0);
        top.SetColumnSpan(profileHeader, 2);
        top.Controls.Add(status, 2, 0);
        var primaryActions = new FlowLayoutPanel { Dock = DockStyle.Fill, WrapContents = false, Margin = Padding.Empty };
        primaryActions.Controls.Add(openChrome);
        primaryActions.Controls.Add(closeChrome);
        primaryActions.Controls.Add(detach);
        top.Controls.Add(primaryActions, 0, 1);
        top.SetColumnSpan(primaryActions, 2);
        top.Controls.Add(more, 2, 1);
    ...
    void ShowWorkerTechnicalInfo(ProfileContext ctx)
    {
        var pid = 0;
        try { pid = ctx.Worker is { HasExited: false } ? ctx.Worker.Id : 0; } catch { }
        var rawStatus = ctx.Status?.Tag as string ?? ctx.Status?.Text ?? "Chưa có trạng thái";
        MessageBox.Show(this,
            $"Profile: {ctx.Profile.Name}\nWorker PID: {(pid > 0 ? pid : "Chưa chạy")}\nChế độ: {(ctx.Detached ? "Cửa sổ riêng" : "Được gắn trong Manager")}\n\nTrạng thái kỹ thuật:\n{rawStatus}",
            "Chi tiết Worker", MessageBoxButtons.OK, MessageBoxIcon.Information);
    }

    void ShowCdpTechnicalInfo(ProfileContext ctx)
    {
        MessageBox.Show(this,
            $"Profile: {ctx.Profile.Name}\nCDP port: {ctx.Profile.CdpPort}\nProfile path: {ctx.Profile.ProfilePath}",
            "Thông tin CDP", MessageBoxButtons.OK, MessageBoxIcon.Information);
    }
    ...
    void OpenProfileChooser()
    {
        ...
        var selection = ChooseProfilesModern(candidates, "Mở profile");
    ...
    {
        await ctx.WorkerStartupGate.WaitAsync();
        try
        {
            var pipeName = PipeName(ctx.Profile.Name);
            if (ctx.Worker is not null && TryGetWorkerAlive(ctx.Worker, out var trackedAlive) && trackedAlive)
            {
                if (await TryPingPipeAsync(ctx.Profile.Name, TimeSpan.FromMilliseconds(700)))
                {
                    await ValidateWorkerHandshakeAsync(ctx);
                    return;
                }

                throw new InvalidOperationException(
                    $"Worker PID {ctx.Worker.Id} vẫn đang chạy nhưng IPC không phản hồi. Manager không mở Worker thứ hai để tránh trùng profile. Hãy dừng Worker cũ rồi thử lại.");
            }
            ...
            // Manager có thể vừa được mở lại trong khi Worker cũ vẫn khỏe.
            // Nhận lại Worker qua handshake/status thay vì spawn một bản trùng.
            if (await TryPingPipeAsync(ctx.Profile.Name, TimeSpan.FromMilliseconds(700)))
            {
                await ValidateWorkerHandshakeAsync(ctx);
                if (await TryBindExistingWorkerAsync(ctx)) return;
                throw new InvalidOperationException(
                    $"Named Pipe '{pipeName}' đang tồn tại nhưng Manager không xác định được tiến trình Worker sở hữu pipe.");
            }

            var exe = Path.GetFullPath(ResolveWorkerExe());
            if (!File.Exists(exe))
                throw new FileNotFoundException($"Không tìm thấy Worker V13: {exe}", exe);

            var dataRoot = Path.GetFullPath(_profileService.ResolveDataRoot(ctx.Profile));
            Directory.CreateDirectory(dataRoot);
            var args = $"--worker --embedded --profile {Quote(ctx.Profile.Name)} --profile-path {Quote(ctx.Profile.ProfilePath)} --cdp-port {ctx.Profile.CdpPort} --data-root {Quote(dataRoot)} --pipe-name {Quote(pipeName)}";
            var timeout = LoadWorkerPipeStartupTimeout();
            _log.Info($"[WORKER_START] profile={ctx.Profile.Name} workerExe={exe} workingDirectory={_baseDir} arguments={args} pipeName={pipeName}");
            ...
            var process = new Process
            {
                StartInfo = new ProcessStartInfo
                {
                    FileName = exe,
                    Arguments = args,
                    WorkingDirectory = Path.GetFullPath(_baseDir),
            ...
            try
            {
                if (!process.Start()) throw new InvalidOperationException("Process.Start trả về false.");
            }
            catch (Exception ex)
            {
                _log.Error($"[WORKER_START_FAILED] exception={ex} workerExe={exe}");
                process.Dispose();
                throw new InvalidOperationException($"Không thể khởi động Worker V13: {ex.Message}", ex);
            }
            ...
            ctx.Detached = false;
            ctx.WorkerStartedUtc = DateTime.UtcNow;
            ctx.WorkerExpectedStop = false;
            ctx.WorkerStopReason = "";
            process.Exited += (_, _) => OnWorkerProcessExited(ctx, process);
            _log.Info($"[WORKER_PROCESS_STARTED] profile={ctx.Profile.Name} pid={pid}");
            _log.Info($"[WORKER_PIPE_WAIT] profile={ctx.Profile.Name} pid={pid} pipeName={pipeName} timeoutMs={(long)timeout.TotalMilliseconds}");
            SetStatus(ctx, $"Worker PID {pid} — đang khởi động IPC", Color.DarkOrange);

            while (stopwatch.Elapsed < timeout)
            {
                if (TryGetWorkerExitCode(process, out var exitCode))
                {
                    _log.Warn($"[WORKER_PIPE_TIMEOUT] profile={ctx.Profile.Name} pid={pid} processAlive=false exitCode={exitCode} elapsedMs={stopwatch.ElapsedMilliseconds} pipeName={pipeName} reason=early_exit");
                    throw new InvalidOperationException(
                        exitCode == 23
                            ? $"Worker cũ của '{ctx.Profile.Name}' đang giữ khóa nhưng Named Pipe không phản hồi. Worker mới đã dừng an toàn (ExitCode=23)."
                            : $"Worker V13 đã thoát trước khi kết nối. ExitCode={exitCode}.");
                }

                if (await TryPingPipeAsync(ctx.Profile.Name, TimeSpan.FromMilliseconds(400)))
                {
                    await ValidateWorkerHandshakeAsync(ctx);
                    stopwatch.Stop();
                    _log.Info($"[WORKER_PIPE_CONNECTED] profile={ctx.Profile.Name} pid={pid} elapsedMs={stopwatch.ElapsedMilliseconds} pipeName={pipeName}");
                    SetStatus(ctx, $"Worker PID {pid} — sẵn sàng", Color.DarkGreen);
                    return;
                }
            ...
            var alive = TryGetWorkerAlive(process, out var processAlive) && processAlive;
            var codeText = TryGetWorkerExitCode(process, out var finalExitCode) ? finalExitCode.ToString() : "n/a";
            _log.Warn($"[WORKER_PIPE_TIMEOUT] profile={ctx.Profile.Name} pid={pid} processAlive={alive} exitCode={codeText} elapsedMs={stopwatch.ElapsedMilliseconds} pipeName={pipeName}");
            if (alive)
            {
                ctx.WorkerExpectedStop = true;
                ctx.WorkerStopReason = "pipe_startup_timeout_cleanup";
                _log.Warn($"[WORKER_TIMEOUT_CLEANUP] profile={ctx.Profile.Name} pid={pid} action=kill_process_tree reason=pipe_unresponsive_after_deadline");
                try { process.Kill(entireProcessTree: true); } catch (Exception ex) { _log.Warn($"[WORKER_TIMEOUT_CLEANUP_FAILED] pid={pid} error={ex.Message}"); }
            }
            throw new TimeoutException(
                $"Worker V13 vẫn chạy nhưng chưa tạo Named Pipe '{pipeName}' sau {(int)timeout.TotalSeconds} giây.");
        }
        finally
        {
            ctx.WorkerStartupGate.Release();
        }
    }

    TimeSpan LoadWorkerPipeStartupTimeout()
    {
        const int defaultSeconds = 30;
        try
        {
            var path = Path.Combine(_baseDir, "manager_worker_ipc.json");
            if (!File.Exists(path)) return TimeSpan.FromSeconds(defaultSeconds);
            using var json = JsonDocument.Parse(File.ReadAllText(path));
            if (json.RootElement.TryGetProperty("WorkerPipeStartupTimeoutSeconds", out var value)
                && value.TryGetInt32(out var seconds))
                return TimeSpan.FromSeconds(Math.Clamp(seconds, 5, 120));
        }
        catch (Exception ex)
        {
            _log.Warn($"[WORKER_IPC_CONFIG_INVALID] error={ex.Message} fallbackSeconds={defaultSeconds}");
        }
        return TimeSpan.FromSeconds(defaultSeconds);
    }

    static bool TryGetWorkerAlive(Process process, out bool alive)
    {
        try { alive = !process.HasExited; return true; }
        catch { alive = false; return false; }
    }

    static bool TryGetWorkerExitCode(Process process, out int exitCode)
    {
        exitCode = 0;
        try
        {
    ...
    static async Task<bool> TryPingPipeAsync(string profileName, TimeSpan timeout)
    {
        try
        {
            return string.Equals(
                await SendPipeAsync(profileName, "ping", timeout),
                "pong",
    ...
    async Task ValidateWorkerHandshakeAsync(ProfileContext ctx)
    {
        var raw = await SendPipeAsync(ctx.Profile.Name, "handshake", TimeSpan.FromSeconds(2));
        WorkerIpcHandshake? handshake;
        try { handshake = WorkerIpcProtocol.ParseHandshake(raw); }
        catch (Exception ex) { throw new InvalidOperationException("Worker V13 không trả về handshake hợp lệ.", ex); }
        if (handshake is null) throw new InvalidOperationException("Worker V13 không trả về handshake.");
        if (handshake.ProtocolVersion != WorkerIpcProtocol.ProtocolVersion)
            throw new InvalidOperationException($"Worker V13 không tương thích protocol. Manager={WorkerIpcProtocol.ProtocolVersion}, Worker={handshake.ProtocolVersion}.");
        if (!string.Equals(handshake.WorkerVersion, AppVersionInfo.Current, StringComparison.OrdinalIgnoreCase))
            throw new InvalidOperationException($"Worker V13 không tương thích phiên bản. Manager={AppVersionInfo.Current}, Worker={handshake.WorkerVersion}.");
        if (!string.Equals(handshake.Profile, ctx.Profile.Name, StringComparison.OrdinalIgnoreCase))
            throw new InvalidOperationException($"Worker Named Pipe không khớp profile. Manager={ctx.Profile.Name}, Worker={handshake.Profile}.");
        _log.Info($"[WORKER_HANDSHAKE_OK] profile={ctx.Profile.Name} managerVersion={AppVersionInfo.Current} workerVersion={handshake.WorkerVersion} protocolVersion={handshake.ProtocolVersion} pipeName={PipeName(ctx.Profile.Name)}");
    }

    async Task<bool> TryBindExistingWorkerAsync(ProfileContext ctx)
    {
        try
        {
            ...
            if (snapshot is null || snapshot.Pid <= 0 || !snapshot.Profile.Equals(ctx.Profile.Name, StringComparison.OrdinalIgnoreCase)) return false;
            var process = Process.GetProcessById(snapshot.Pid);
            if (process.HasExited) { process.Dispose(); return false; }
            process.EnableRaisingEvents = true;
            ctx.Worker = process;
            ctx.WorkerStartedUtc = process.StartTime.ToUniversalTime();
            ctx.WorkerExpectedStop = false;
            ctx.WorkerStopReason = "";
            process.Exited += (_, _) => OnWorkerProcessExited(ctx, process);
            _log.Info($"[WORKER_EXISTING_BOUND] profile={ctx.Profile.Name} pid={snapshot.Pid} pipeName={PipeName(ctx.Profile.Name)}");
            return true;
        }
        catch (Exception ex)
        {
            _log.Warn($"[WORKER_EXISTING_BIND_FAILED] profile={ctx.Profile.Name} error={ex.Message}");
            return false;
        }
    }
    ...
    async Task<string> SendCommandAsync(ProfileContext ctx, string command, TimeSpan? timeout = null)
    {
        ...
        try
        {
            ...
            {
                ctx.WorkerExpectedStop = true;
                ctx.WorkerStopReason = "manager_shutdown_command";
            }
    ...
    void RemoveTab(ProfileContext ctx)
    {
        ...
        EnsureAddTab(); UpdateWorkspaceTabBarAppearance(); RefreshAvailability(); UpdateTitle();
    }
    ...
    ProfileCreateRequest? ShowAddProfileDialog(TikTokProfileCatalog catalog)
    {
        ...
        {
            Text = $"Thêm hồ sơ — {AppVersionInfo.Display}",
            Width = 780,
            Height = 850,
        ...
        nameBox.PlaceholderText = "Nhập tên profile (ví dụ: acc01)";
        usernameBox.PlaceholderText = "Nhập username, email hoặc số điện thoại";
        passwordBox.PlaceholderText = "Nhập mật khẩu";
        totpBox.PlaceholderText = "Nhập mã secret 2FA (nếu có)";
        ...
        UiTheme.ApplyRoundedCorners(selectedAccountSummary, 9);
        ...
        var note = new Label
        {
            ...
            Font = new Font("Segoe UI", 9.5F),
            Text = "ⓘ  Mật khẩu và secret 2FA được mã hóa bằng Windows DPAPI. Nếu TikTok yêu cầu CAPTCHA, công cụ sẽ chờ bạn xử lý xong rồi tự tiếp tục đăng nhập."
        };
        UiTheme.ApplyRoundedCorners(note, 12);
        ...
        var row = 0;
        root.Controls.Add(L("Tên profile *", true), 0, row++); root.Controls.Add(nameBox, 0, row++);
        root.Controls.Add(Helper("Tên này sẽ hiển thị trong danh sách hồ sơ."), 0, row++);
        ...
        root.Controls.Add(L("Tài khoản TikTok (username / email / số điện thoại)", true), 0, row++); root.Controls.Add(usernameBox, 0, row++);
        root.Controls.Add(Helper("Tài khoản sẽ được sử dụng để đăng nhập vào TikTok."), 0, row++);
        root.Controls.Add(L("Mật khẩu TikTok", true), 0, row++); root.Controls.Add(passwordBox, 0, row++);
        root.Controls.Add(Helper("Mật khẩu được mã hóa và lưu an toàn bằng Windows DPAPI."), 0, row++);
        root.Controls.Add(L("Secret 2FA/TOTP (không phải mã 6 số; có thể để trống)", true), 0, row++); root.Controls.Add(totpBox, 0, row++);
        root.Controls.Add(Helper("Dùng cho xác thực 2 lớp. Bạn có thể để trống nếu không sử dụng."), 0, row++);
        var optionsCard = new ModernCardPanel
        {
            Dock = DockStyle.Top,
            AutoSize = true,
            AutoSizeMode = AutoSizeMode.GrowAndShrink,
        ...
        optionsLayout.Controls.Add(showSecrets);
        optionsLayout.Controls.Add(autoLogin);
        optionsCard.Controls.Add(optionsLayout);
        root.Controls.Add(optionsCard, 0, row++);
        root.Controls.Add(note, 0, row++);
        contentHost.Controls.Add(root);

        var create = new Button { Text = "Thêm hồ sơ", Size = new Size(132, 42) };
        ...
        UiTheme.ApplyRoundedCorners(headerIcon, 15);
        ...
        {
            Text = "Tạo hồ sơ mới để quản lý và tự động hóa với TikTok.",
            AutoSize = true,
        ...
        UiTheme.ApplyRoundedCorners(versionBadge, 16);
        header.Controls.Add(headerIcon);
        header.Controls.Add(headerTitle);
        header.Controls.Add(headerSubtitle);
        header.Controls.Add(versionBadge);
        header.Layout += (_, _) => versionBadge.Location = new Point(
            Math.Max(0, header.ClientSize.Width - versionBadge.Width - 24), 32);
    ...
    async Task RenameSelectedProfileAsync()
    {
        ...
        var newName = PromptRenameProfile(oldName);
    ...
    void UpdateTitle()
    {
        ...
        Text = selected is null
            ? $"TikTok Operations Center {AppVersionInfo.Display}"
            : $"TikTok Operations Center {AppVersionInfo.Display} — {selected.Profile.Name}";
        RefreshSelectedProfilePresentation();
    }
    ...
    void RefreshSelectedProfilePresentation()
    {
        ...
        foreach (var context in _contexts.Values)
        {
            ...
            var headerText = context.Profile.Name;
            ...
            if (notesByProfile.TryGetValue(context.Profile.Name, out var noteText))
            {
                var compactNote = noteText.Length > 28
                    ? noteText[..28] + "…"
                    : noteText;
                headerText += $"  ·  {compactNote}";
            }

            header.Text = headerText;
            header.BackColor = UiTheme.Card;
    ...
    void SetStatus(ProfileContext ctx, string text, Color color)
    {
        ...
        var friendly = normalized.Contains("lỗi") || normalized.Contains("thoát") || normalized.Contains("mất kết nối")
            ? "● Worker cần kiểm tra"
            : normalized.Contains("khởi động") || normalized.Contains("đang mở") || normalized.Contains("đang đóng") || normalized.Contains("tạm thời")
                ? "● Worker đang khởi tạo"
                : normalized.Contains("sẵn sàng") || normalized.Contains("kết nối") || normalized.Contains("khôi phục")
                    ? "● Worker hoạt động"
                    : normalized.Contains("stopped") || normalized.Contains("đã dừng")
                        ? "● Worker chưa chạy"
                        : "● Worker hoạt động";
        ctx.Status.Text = friendly;
        ctx.Status.ForeColor = color;
        _managerToolTip.SetToolTip(ctx.Status, text);
    }
    ...
    static string PipeName(string profileName) => WorkerIpcProtocol.BuildPipeName(profileName);
