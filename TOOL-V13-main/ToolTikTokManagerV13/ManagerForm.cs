...
public sealed partial class ManagerForm : Form
{
    ...
    void BuildLayout()
    {
        ...
        shell.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 252F));
        ...
        nav.Controls.Add(Section("Không gian làm việc"));
        nav.Controls.Add(NavButton("▦  Bảng điều khiển", (_, _) =>
        {
            if (_dashboardTab is not null) SelectTabPageSafely(_dashboardTab);
        }, UiButtonKind.Primary));
        nav.Controls.Add(NavButton("＋  Mở hồ sơ làm việc", (_, _) => OpenProfileChooser()));
        nav.Controls.Add(NavButton("＋  Tạo hồ sơ mới", (_, _) => AddProfile()));
        nav.Controls.Add(NavButton("⚡  Tạo hồ sơ tự động", (_, _) => ShowAutoProfileDialog()));

        nav.Controls.Add(Section("Quản lý"));
        nav.Controls.Add(NavButton("◫  Quản lý tài khoản", (_, _) => ShowAccountPoolDialog()));
        nav.Controls.Add(NavButton("◇  Thiết lập mặc định", (_, _) => ShowDefaultConfigDialog()));
        ...
        nav.Controls.Add(NavButton("↳  Nhập hồ sơ có sẵn", async (_, _) => { try { await AddExistingProfileAsync(); } catch (Exception ex) { ShowError(ex); } }));
        nav.Controls.Add(NavButton("✎  Đổi tên hồ sơ", async (_, _) => { try { await RenameSelectedProfileAsync(); } catch (Exception ex) { ShowError(ex); } }));
        nav.Controls.Add(NavButton("↻  Đồng bộ với Chrome", (_, _) => ShowChromeNameSyncDialog()));
        nav.Controls.Add(NavButton("▣  Theo dõi cửa sổ", (_, _) => ShowChromeMonitor()));
        nav.Controls.Add(NavButton("×  Xóa hồ sơ", (_, _) => ShowDeleteProfilesDialog(), UiButtonKind.Danger));
        ...
        sidebarFooter.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
        sidebarFooter.RowStyles.Add(new RowStyle(SizeType.Absolute, 46F));
        ...
        startAll.Margin = new Padding(0, 0, 4, 4);
        stopAll.Margin = new Padding(4, 0, 0, 4);
        ...
        _availability.Margin = new Padding(0);
        _availability.ForeColor = Color.FromArgb(148, 163, 184);
        _availability.Font = new Font("Segoe UI", 8.5F);
        sidebarFooter.Controls.Add(startAll, 0, 0);
        sidebarFooter.Controls.Add(stopAll, 1, 0);
        sidebarFooter.Controls.Add(_availability, 0, 1);
        ...
        welcome.Controls.Add(new Label
        {
            Text = "Quản lý hồ sơ, trình duyệt Chrome và quy trình tự động hóa tập trung.",
            AutoSize = true,
        ...
        var headerActions = new TableLayoutPanel
        {
            ...
            ColumnCount = 3,
            RowCount = 1,
            Padding = new Padding(6, 10, 0, 12),
            Margin = Padding.Empty,
            BackColor = Color.FromArgb(248, 250, 252)
        };
        headerActions.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 29F));
        headerActions.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 28F));
        headerActions.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 43F));
        ...
        headerActions.Controls.Add(health, 0, 0);
        headerActions.Controls.Add(version, 1, 0);
        headerActions.Controls.Add(checkUpdate, 2, 0);
        workspaceHeader.Controls.Add(welcome, 0, 0);
        workspaceHeader.Controls.Add(headerActions, 1, 0);

        var tabCard = new ModernCardPanel
        {
            Dock = DockStyle.Fill,
