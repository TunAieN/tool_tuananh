...
if not exist "installer\windows\ToolTikTok.iss" (
    echo [LOI] Khong tim thay installer\windows\ToolTikTok.iss
    echo.
...
"%ISCC%" /DMyAppVersion=%APP_VERSION% "installer\windows\ToolTikTok.iss"
