...
dotnet build ".\src\ToolTikTok.Worker\ToolTikTok.Worker.csproj" -c Release
if errorlevel 1 goto :fail

echo.
echo [2/2] Build Manager V%APP_VERSION%...
dotnet build ".\src\ToolTikTok.Manager\ToolTikTok.Manager.csproj" -c Release
if errorlevel 1 goto :fail
...
echo Kiem tra VERSION.txt va scripts\SYNC_VERSION.ps1
echo ========================================
echo.
if /I not "%NOPAUSE%"=="--no-pause" pause
exit /b 1
